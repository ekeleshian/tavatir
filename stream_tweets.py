...
def set_rules(headers, delete, bearer_token):
    ...
    sample_rules = [
        {"value": "(#StopArmenianAggression OR #StopArmenianTerrorism OR #ArmeniaKillsChildren OR #StopArmenianTerror OR #KarabakhisAzerbaijan OR #Azerbaijanphobia OR #DontBelieveArmenia OR #StopArmenianLies) lang:en"},
    ]
